...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <asp:TextBox ID="txt_vnome" runat="server" Height="30px" Width="300px" CssClass="form-control"></asp:TextBox>
    </div>
    ...
    <div>
        ...
        <asp:TextBox ID="txt_vcpf" runat="server" Height="30px" Width="300px" CssClass="form-control"></asp:TextBox>
    </div>
    ...
    <div>
        ...
        <asp:TextBox ID="txt_vendereco" runat="server" Height="30px" Width="300px" CssClass="form-control"></asp:TextBox>
    </div>    
    ...
    <div>
        ...
        <asp:TextBox ID="txt_vnumero" runat="server" Height="30px" Width="300px" CssClass="form-control"></asp:TextBox>
    </div>
    <div>
        ...
        <asp:TextBox ID="txt_vBairro" runat="server" Height="30px" Width="300px" CssClass="form-control"></asp:TextBox>
    </div>
    ...
    <div>
        ...
        <asp:TextBox ID="txt_vcep" runat="server" Height="30px" Width="300px" CssClass="form-control"></asp:TextBox>
    </div>
    ...
    <div>
        ...
        <asp:TextBox ID="txt_vCidade" runat="server" Height="30px" Width="300px" CssClass="form-control"></asp:TextBox>
    </div>

    <div>
        <asp:Label ID="lbl_vEstado" runat="server" Text="Estado"></asp:Label>
        <asp:DropDownList ID="drp_vEstado" runat="server" Height="30px" CssClass="form-control" Width="300px">
    ...
    <div>
        ...
        <asp:TextBox ID="txt_vDispo" runat="server" Height="30px" Width="300px" CssClass="form-control"></asp:TextBox>
    </div>
    ...
    <div>
        ...
        <asp:TextBox ID="txt_vSerDisp" runat="server" Height="30px" Width="300px" CssClass="form-control"></asp:TextBox>
    </div>
