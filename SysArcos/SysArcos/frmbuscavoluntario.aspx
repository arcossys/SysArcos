...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Label ID="lbl_busca" runat="server" Text="Busca" Height="30px" Width="50px"></asp:Label>
    <asp:TextBox ID="txt_Busca" runat="server" Height="30px" Width="300px"></asp:TextBox>
    &nbsp;&nbsp;
    <asp:Button ID="btn_Busca" class="btn btn-success" runat="server" Text="Vai!" OnClick="btn_Busca_Click" Height="30px" />
    <br />
    ...
    <br />
    <br />
    <asp:Button ID="btn_Alterar" runat="server" class="btn btn-primary" Font-Bold="True" Text="Alterar" OnClick="btn_Alterar_Click" />
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="btn_Remover" runat="server" class="btn btn-primary" Font-Bold="True" Text="Remover" OnClick="btn_Remover_Click" />
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="btn_Voltar" runat="server" class="btn btn-primary" Font-Bold="True" Text="Voltar" OnClick="btn_Voltar_Click" />
</asp:Content>
