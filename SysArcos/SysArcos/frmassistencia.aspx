...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group" >               
        ...
        <asp:Label ID="lblAcao" runat="server" Text="NOVO"></asp:Label>
                 ...
                 <asp:TextBox ID="txt_inicial" class="form-control" runat="server" MaxLength="14" Placeholder="XXX.XXX.XXX-XX" Width="300px"></asp:TextBox>
             </div>
                 <div  >                   
                   <asp:Label ID="Label2" runat="server" Text="Data Final"></asp:Label>
                   <asp:TextBox ID="txt_final" class="form-control" runat="server" MaxLength="14" Placeholder="XXX.XXX.XXX-XX" Width="300px"></asp:TextBox>
                 </div>
               <div  >                   
                   <asp:Label ID="lbl_cpf" runat="server" Text="Descrição"></asp:Label>
                   <asp:TextBox ID="txt_descricao" class="form-control" runat="server" MaxLength="14" Placeholder="XXX.XXX.XXX-XX" Width="300px"></asp:TextBox>
                 </div>
                 <div >                   
