        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12 col-lg-4 row_buttons">
                    <asp:Button ID="btn_Limpar" class="btn btn-primary" Font-Bold="True" runat="server" OnClick="btn_Limpar_Click" Text="Novo" Width="100%"/>
                </div>
                <div class="col-12 col-lg-4 row_buttons">
                    <asp:Button ID="btn_Cadastrar" class="btn btn-primary" Font-Bold="True" runat="server" Text="Salvar" OnClick="btn_Cadastrar_Click" ValidationGroup="Cadastrar" Width="100%"/>
                </div>
                <div class="col-12 col-lg-4 row_buttons">
                    <asp:Button ID="btn_Consultar" class="btn btn-primary" Font-Bold="True" runat="server" Text="Buscar" OnClick="btn_Consultar_Click" Width="100%"/>
                </div>
                <br />
            </div>
        </div>
