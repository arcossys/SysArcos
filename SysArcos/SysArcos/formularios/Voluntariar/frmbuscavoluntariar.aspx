...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <asp:RadioButton ID="rbVoluntario" runat="server" Text="Voluntário" Groupname="filtro" />
    <asp:RadioButton ID="rbVoluntariado" runat="server" Text="Voluntariado" Groupname="filtro" />
    <br />
    <br />
    </div>
    <div>
