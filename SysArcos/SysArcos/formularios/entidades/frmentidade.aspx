            ...
            <div class="row">
                ...
                <div class="cold-12 col-lg-4">
                    <div class="row_fields">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtCNPJ" ErrorMessage="RequiredFieldValidator" ForeColor="#FF3300" ValidationGroup="form">*</asp:RequiredFieldValidator>
