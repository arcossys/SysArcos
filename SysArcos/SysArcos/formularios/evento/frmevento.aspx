...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-12 col-lg-4">
            ...
            <asp:TextBox ID="txtDataInicio" runat="server" CssClass="form-control" Width="100%" MaxLength="50" Height="40px" Placeholder="DD/MM/AAAA HH:MM" TextMode="Date"></asp:TextBox>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-12 col-lg-4 row_buttons"> 
        <asp:Button ID="btnSalvar" runat="server" CssClass="btn btn-primary" Text="Salvar" Width="100%" Font-Size="X-Large" />
    </div>
