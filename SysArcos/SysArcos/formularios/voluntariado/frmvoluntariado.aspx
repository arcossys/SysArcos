...
&nbsp;<asp:TextBox ID="txtDataini" class="form-control" runat="server" MaxLength="50" Width="300px" Placeholder="DD/MM/AAAA"></asp:TextBox>
    </p>
    <p>
        &nbsp;<asp:Label ID="lblDataFinal" runat="server" Text="Data Final"></asp:Label>
&nbsp;<asp:TextBox ID="txtDatafinal" class="form-control" runat="server" MaxLength="50" Width="300px" Placeholder="DD/MM/AAAA"></asp:TextBox>
    </p>
    <p>
